...
public class Empresa extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		String raxSocial = txtRazonSocial.getText() ;
		String numero = txtNumeroEmpleados.getText() ;
		String anual = txtUtilidadAnual.getText() ;
		
		txtS.setText("Razon Social : " + raxSocial + "\n" );
		txtS.setText("Numero Empleados : " + numero + "\n" );
		txtS.setText("Utilidad Anual : " + anual + "\n" );
