...
public class Persona extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		String Nombres = txtNombresApellidos.getText() ;
		String Nacimiento = txtAñoNacimiento.getText() ;
		String Kilogramos = txtPesoKilogramos.getText() ;
		
		txtS.setText("Nombres ; " + Nombres + "\n");
		txtS.setText("Nacimiento ; " + Nacimiento + "\n");
		txtS.setText("Kilogramos ; " + Kilogramos + "\n");
